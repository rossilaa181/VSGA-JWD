...
session_start();
/** Cek apakah variabel global $_SESSION['sesi'] ada dan tidak kosong (yang berati aktif login)*/
	...
	<div id="container">
		<div id="header">
			<div id="logo-perpustakaan-container">
				<image id="logo-perpustakaan" src="images/logo-perpustakaan3.png" border=0 style="border:0; 
		...
		<div id="header2">
		<!-- memanggil variabel global SESSION dengan parameter 'sesi' yang telah dideklarasikan dalam file konek.php -->
